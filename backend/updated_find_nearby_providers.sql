-- Updated Find Nearby Providers function that:
-- 1. Handles null service_type parameter
-- 2. Returns additional fields needed by the UI (serviceTypes, availability)
-- 3. Includes distance calculation in the result

-- Create a type to return structured provider data
DO $$ 
BEGIN
